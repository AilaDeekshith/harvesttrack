...
const globalStyles = StyleSheet.create({
  ...
  headerTitle:    { color: Colors.white, fontSize: 22, fontWeight: 'bold', marginTop: 2 },
  headerIcon: {
    backgroundColor: '#ffffff22', borderRadius: 50,
    width: 48, height: 48,
  ...
  jobCard: {
    ...
    shadowColor: Colors.cardShadow, shadowOpacity: 0.05,
  ...
  jobBadge:    { borderRadius: 20, paddingHorizontal: 10, paddingVertical: 3, marginTop: 4 },
  ...
  tabLabel:       { fontSize: 10, color: Colors.textLight, marginTop: 3, fontWeight: '500' },
  ...
  inputLabel: { fontSize: 13, fontWeight: '600', color: Colors.textMuted, marginBottom: 4 },
  ...
  statChipValue: { fontSize: 14, fontWeight: '700', color: Colors.text, marginTop: 2 },
  ...
  errorText:  { color: '#e74c3c', fontSize: 12, marginTop: -8, marginBottom: 8, marginLeft: 4 },
  ...
  headerEarningsLabel: { color: Colors.primaryLight, fontSize: 12, marginTop: 2 },
  ...
  noData:     { color: Colors.textLight, fontSize: 14, textAlign: 'center', padding: 20 },
  ...
  barLabel:   { width: 52, fontSize: 11, color: Colors.textMuted, fontWeight: '500' },
  barWrapper: { flex: 1, marginHorizontal: 8 },
  barBg: {
    backgroundColor: Colors.background,
    borderRadius: 6, height: 20, overflow: 'hidden',
  },
  barFill: { height: '100%', borderRadius: 6 },
  barValue: { width: 60, fontSize: 11, color: Colors.text, fontWeight: '700', textAlign: 'right' },
  ...
  cropCardName:   { flex: 1, fontSize: 15, fontWeight: '700', color: Colors.text },
  ...
  customerBannerAvatarText: { color: Colors.white, fontSize: 26, fontWeight: '800' },
  customerBannerName:       { fontSize: 18, fontWeight: '800', color: Colors.text },
  customerBannerVillage:    { fontSize: 13, color: Colors.textMuted, marginTop: 4 },
  ...
  avgLabel:   { fontSize: 13, color: Colors.textMuted, fontWeight: '600', marginBottom: 12 },
  ...
  inputPlaceholder: { fontSize: 15, color: Colors.textLight, fontWeight: '400' },
